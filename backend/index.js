...
app.use(
  cors({
    origin:["http://localhost:5173", "https://chatease-a11c7.web.app"], // Allow all origins, you can replace "*" with specific domains like ["http://localhost:3000"] for more security
    methods: ["GET", "POST"],
...
const io = new Server(server, {
  cors: {
    origin:["http://localhost:5173", "https://chatease-a11c7.web.app"], // Client's URL
    methods: ["GET", "POST"],
    credentials: true,
  },
});
